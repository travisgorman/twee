...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router = _backbone2.default.Router.extend({
		...
		loginRoute: function loginRoute() {
			...
			(0, _jquery2.default)('#app').empty().append(login.render().$el);
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = _backbone2.default.View.extend({
		tagName: 'form',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Signup = _backbone2.default.View.extend({
		tagName: 'form',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Twee = _backbone2.default.Model.extend({
		...
		defaults: {
			...
			username: '',
			body: '',
			timestamp: (0, _moment2.default)().format('MMM Do YYYY, h:mm a')
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".create-twee {\n  padding: 1rem;\n  width: 100%;\n  text-align: center; }\n  .create-twee input {\n    padding: .75rem;\n    font-size: 1rem;\n    border-radius: 6px; }\n  .create-twee input[type=\"submit\"] {\n    border: none;\n    font-width: lighten;\n    color: #fff;\n    background: #34BD87; }\n  .create-twee input[type=\"text\"] {\n    width: 60%; }\n\n.login-form {\n  border-radius: 3px;\n  width: 500px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  background: #5fd2e5; }\n  .login-form h2 {\n    color: #333; }\n  .login-form input {\n    font-size: 1rem;\n    width: 400px;\n    margin: .5rem;\n    padding: .5rem;\n    border: none;\n    border-radius: 3px;\n    color: #333333; }\n  .login-form input.loginBtn {\n    background: #148E8E;\n    color: #EEEEEE;\n    letter-spacing: 2px;\n    font-weight: 100;\n    width: 140px;\n    padding: .5rem;\n    border-radius: 6px; }\n    .login-form input.loginBtn:hover {\n      background: #34BD87; }\n  .login-form p {\n    color: #333333;\n    margin-right: .5rem; }\n  .login-form a {\n    color: #BE2C23;\n    text-decoration: none; }\n    .login-form a:hover {\n      text-decoration: underline; }\n\n.signup-form {\n  border-radius: 3px;\n  width: 500px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  background: #5fd2e5; }\n  .signup-form h2 {\n    color: #333; }\n  .signup-form input {\n    font-size: 1rem;\n    width: 400px;\n    margin: .5rem;\n    padding: .5rem;\n    border: none;\n    border-radius: 3px;\n    color: #333333; }\n  .signup-form input.signupBtn {\n    background: #148E8E;\n    color: #EEEEEE;\n    letter-spacing: 2px;\n    font-weight: 100;\n    width: 140px;\n    padding: .5rem;\n    border-radius: 6px; }\n    .signup-form input.signupBtn:hover {\n      background: #34BD87; }\n  .signup-form p {\n    color: #333333;\n    margin-right: .5rem; }\n  .signup-form a {\n    color: #BE2C23;\n    text-decoration: none; }\n    .signup-form a:hover {\n      text-decoration: underline; }\n\nnav {\n  background: #193549;\n  color: #EEEEEE;\n  letter-spacing: 2px;\n  font-size: 1.4rem;\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  align-self: flex-start;\n  width: 100%;\n  padding: 0 1.5rem; }\n  nav button {\n    padding: .5rem 1.3rem;\n    background: #34BD87;\n    border: none;\n    color: #EEEEEE;\n    font-weight: 100;\n    letter-spacing: 2px;\n    font-size: 1.4rem;\n    border-radius: 8px; }\n    nav button:hover {\n      background: #54d09f;\n      cursor: pointer; }\n  nav .username {\n    display: flex;\n    letter-spacing: 2px;\n    justify-content: flex-end;\n    flex: 1; }\n    nav .username h3 {\n      font-size: 1.4rem;\n      font-weight: 100; }\n      nav .username h3 span {\n        color: #FC4756; }\n      nav .username h3 .logo {\n        color: #34BD87; }\n\n.twee-list-view {\n  width: 65%; }\n\n.twee-list {\n  margin: 0;\n  padding: 0;\n  list-style-type: none; }\n\n.twee-item {\n  background: #FFFFFF;\n  padding: 1rem;\n  margin: 1.25rem;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.19), 0 6px 6px rgba(0, 0, 0, 0.23); }\n  .twee-item h5 {\n    display: inline-block;\n    margin: 0;\n    padding: 0; }\n  .twee-item header {\n    display: flex; }\n    .twee-item header .whois {\n      width: 60%; }\n      .twee-item header .whois .author {\n        color: #333;\n        margin-right: .6rem; }\n      .twee-item header .whois .username {\n        font-weight: 200;\n        font-size: 12px;\n        color: blue;\n        margin-right: .6rem; }\n    .twee-item header .actions {\n      width: 40%;\n      display: flex;\n      justify-content: flex-end; }\n      .twee-item header .actions button {\n        border: none;\n        margin-left: .5rem;\n        align-self: baseline; }\n      .twee-item header .actions .editBtn {\n        background: #34BD87;\n        color: #fff; }\n      .twee-item header .actions .deleteBtn {\n        background: #FC4756;\n        color: #fff; }\n  .twee-item footer {\n    display: flex;\n    justify-content: flex-end;\n    align-items: center; }\n    .twee-item footer .timestamp {\n      font-weight: 100;\n      padding: 0 1.5rem;\n      color: #adadad;\n      font-size: 12px;\n      align-self: center;\n      font-style: italic; }\n  .twee-item p {\n    padding: 0 1.5rem;\n    margin-bottom: .5rem;\n    font-size: .9rem;\n    font-weight: lighter; }\n\nform.update {\n  padding: .9rem; }\n  form.update input[type=\"text\"] {\n    width: 75%;\n    padding: .5rem;\n    margin-right: 1rem;\n    font-size: .9rem;\n    border: 1px solid #dadada; }\n  form.update input[type=\"submit\"] {\n    border: none;\n    padding: none; }\n  form.update input[type=\"button\"] {\n    border: none; }\n  form.update .updateBtn {\n    background: #34BD87;\n    color: #fff; }\n  form.update .cancelBtn {\n    background: #FC4756;\n    color: #fff; }\n\n* {\n  box-sizing: border-box; }\n\nbody {\n  margin: 0;\n  padding: 0;\n  font-family: sans-serif;\n  background: #EEEEEE;\n  font-size: 16px; }\n\n.container {\n  min-height: 100vh;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center; }\n\nul {\n  padding-start: 0; }\n", ""]);
